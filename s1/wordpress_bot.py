...
import random
from news_model import ndtv_fashion_scraper

ndtv_fashion_news_data = ndtv_fashion_scraper()
print(ndtv_fashion_news_data)

image = str("C:/Users/Lenovo/Desktop/site_automation/s1/image/1.jpg")
count = 1
...
try:
    ...
    login()
wd.refresh()
for data in ndtv_fashion_news_data:
    #clicking new post
    time.sleep(2)
    try:
